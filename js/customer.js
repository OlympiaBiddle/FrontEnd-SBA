...
const checkBirthday = () => {
  ...
  if (!isRequired(birthday)) {
    showError(birthdayEl, 'Birthdate cannot be blank.');
  } else if (!isBirthdayValid(birthday)) {
    showError(birthdayEl, `Birthdate must be in mm/dd/yyyy.`)
  } else {
...
form.addEventListener('submit', function (e) {
  ...
  let isBirthdayValid = checkBirthday(),
    ...
    isFisrtnameValid = checkFirstname(),
    isUsernameValid = checkUsername(),
    isEmailValid = checkEmail(),
    isPasswordValid = checkPassword(),
    isConfirmPasswordValid = checkConfirmPassword();

  let isFormValid = isFisrtnameValid &&
    isLastnameValid &&
    isBirthdayValid &&
    isUsernameValid &&
    isEmailValid &&
  ...
  if (isFormValid) {
    x.addEventListener('click', addCustomer);
  }
});
